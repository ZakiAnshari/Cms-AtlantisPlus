        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Atlantis</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Dashboard -->
            <li @if(request()->route()->uri == 'dashboard') class='menu-item active' @else class='menu-item' @endif>
            ...
            <!-- Components -->
              ...
              <li @if(request()->route()->uri == 'about') class='menu-item active' @else class='menu-item' @endif>
              ...
              <li @if(request()->route()->uri == 'prestasi' || request()->route()->uri == 'prestasi-add' ||  request()->route()->uri == 'prestasi-edit/{slug}' || request()->route()->uri == 'prestasi-delete/{slug}' ) class='menu-item active' @else class='menu-item' @endif>
                <a href="prestasi" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-crown"></i>
                  <div data-i18n="Basic">Prestasi</div>
                </a>
              </li>

              <li @if(request()->route()->uri == 'teacher' || request()->route()->uri == 'teacher-add' || request()->route()->uri == 'teacher-edit/{slug}' || request()->route()->uri == 'teacher-delete/{slug}'  )  class='menu-item active' @else class='menu-item' @endif>
              ...
              <li @if(request()->route()->uri == 'gallery') class='menu-item active' @else class='menu-item' @endif>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset('backend/sneat-1.0.0/assets/img/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Zaki</span>
